...
export class MovieService {
    ...
    constructor(private _jsonp: Jsonp) {
        this.apikey = '41f70eca72dfe42346027e7ce39d61af',
  ...
  getInTheaters() {
    return this._jsonp.get('https://api.themoviedb.org/3/discover/movie?callback=JSONP_CALLBACK&primary_release_date.gte=2016-12-01&primary_release_date.lte=2017-01-10&api_key=' + this.apikey)
        .map(res => res.json());
  }
